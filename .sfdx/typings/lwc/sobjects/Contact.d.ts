...
declare module "@salesforce/schema/Contact.Opportunity__r" {
  const Opportunity__r:any;
  export default Opportunity__r;
}
declare module "@salesforce/schema/Contact.Opportunity__c" {
  const Opportunity__c:any;
  export default Opportunity__c;
}
declare module "@salesforce/schema/Contact.Reviewer__r" {
  const Reviewer__r:any;
  export default Reviewer__r;
}
declare module "@salesforce/schema/Contact.Reviewer__c" {
  const Reviewer__c:any;
  export default Reviewer__c;
}
declare module "@salesforce/schema/Contact.Contact_Reviewer__c" {
  const Contact_Reviewer__c:string;
  export default Contact_Reviewer__c;
}
declare module "@salesforce/schema/Contact.Status__c" {
